...
export const NavLinks = {
  enhance: {
    ...
    items: [
      ...
      { id: 'restore-color', to: "/color-restoration", label: "Restore Color", isAi: true, icon: "M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.894 20.567L16.5 21.75l-.394-1.183a2.25 2.25 0 00-1.423-1.423L13.5 18.75l1.183-.394a2.25 2.25 0 001.423-1.423l.394-1.183.394 1.183a2.25 2.25 0 001.423 1.423l1.183.394-1.183.394a2.25 2.25 0 00-1.423 1.423z", desc: "Restore colors to faded or desaturated images." },
    ]
  },
  edit: {
    title: "Smart Edit",
    items: [
      ...
      { id: 'crop', to: "/crop-image", label: "Crop Image", isAi: false, icon: "M14 10l-2 1m0 0l-2-1m2 1v2.5M20 7l-2 1m2-1l-2-1m2 1v2.5M14 4l-2-1-2 1M4 7l2-1M4 7l2 1M4 7v2.5M12 21l-2-1m2 1l2-1m-2 1v-2.5M6 18l-2-1v-2.5M18 18l2-1v-2.5", desc: "Trim edges or cut out specific ratios." },
  ...
  tools: {
    ...
    items: [
      ...
      { id: 'watermark', to: "/watermark-adder", label: "Add Watermark", isAi: false, icon: "M12 21a5.001 5.001 0 01-5-5c0-2.5 3-6.5 5-9 2 2.5 5 6.5 5 9a5.001 5.001 0 01-5 5z M12 11v4m-2-2h4", desc: "Stamp logos or text to protect your work." },
    ]
  }
};