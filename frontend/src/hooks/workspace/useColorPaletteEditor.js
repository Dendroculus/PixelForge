...
import { clamp, makeInitialPoints, resizePoints } from '../../utils/image/paletteMath';
 ...
 */
export function useColorPaletteEditor({ previewUrl, samplePaletteFromPoints, imageRef, previewContainerRef }) {
