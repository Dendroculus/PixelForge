  ...
  return (
    <section className="flex-1 w-full max-w-6xl mx-auto px-4 pt-6 pb-16">
      <motion.div 
        ...
        className="w-full min-h-96 rounded-3xl border border-white/70 bg-white/50 backdrop-blur-xl shadow-xl shadow-indigo-500/5 flex flex-col"
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-white/40 flex-1">
                ...
                <AnimatePresence>
                  {isDropdownOpen && (
                    <motion.div
                      ...
                      className="absolute z-50 top-full left-0 w-full mt-1.5 rounded-xl border border-slate-200 bg-white shadow-xl overflow-hidden"                    >
          ...
          <div className="p-8 md:p-10 bg-white/20 flex flex-col">
