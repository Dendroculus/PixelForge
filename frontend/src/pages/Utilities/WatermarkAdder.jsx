                ...
                <div className="space-y-3 pb-1">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <div className={`relative h-7 w-7 shrink-0 rounded-full bg-gradient-to-tr from-rose-400 via-fuchsia-500 to-indigo-500 shadow-sm transition-all flex items-center justify-center cursor-pointer ${!WATERMARK_COLORS.includes(textWm.color) ? 'ring-2 ring-indigo-500 ring-offset-2' : 'hover:scale-105'}`}>
