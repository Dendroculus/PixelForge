...
13. 🤖 **聊天机器人** — 用来快速解答问题、还能一步步带你了解平台的 FAQ 小助手
...
14. 📝 **用户反馈系统** — 用户输入用于产品改进和缺陷报告

### B) 平台与系统能力

15. 🛡️ **Turnstile 验证** — 机器人防护层  
16. 📊 **使用配额限制** — 按功能维度每日限额  
17. 🚦 **API 限流机制** — 稳定控制接口流量  
18. ⚙️ **异步任务队列** — 安全处理后台任务  
19. 🔄 **状态轮询机制** — processing / ready / failed  
20. 💾 **会话持久化** — IndexedDB + localStorage  
21. 🔁 **会话恢复** — 刷新后自动恢复处理状态  
22. ⏳ **过期管理机制** — 结果与草稿生命周期控制  
23. 🧽 **Azure 清理任务** — 自动清理过期结果  
24. 🧹 **数据库清理任务** — 使用数据定期维护  
25. 🔑 **签名 URL** — 安全上传与访问  
26. 🔍 **文件校验** — 类型、大小、伪装检测  
27. 🏷️ **文件名清洗** — 安全文件命名处理  
28. 🧩 **Workspace 工作区系统** — 可复用 UI 外壳  
29. 📢 **模态框系统** — 法务与告警提示统一管理  
30. 🆚 **对比滑块** — 前后效果直观对照  
31. 🎬 **进度体验优化** — 分阶段加载反馈 
